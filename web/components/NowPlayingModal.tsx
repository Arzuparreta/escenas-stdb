          ...
          <Dialog.Portal forceMount>
            ...
            >
              <motion.div
                ...
                className="fixed left-1/2 top-1/2 z-[81] w-[min(58rem,92vw)] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-2xl border border-line bg-surface shadow-lift"
              >
                {/* Player */}
                ...
                <Dialog.Close asChild>
                  <button
                    aria-label="Cerrar"
                    className="absolute right-3 top-3 z-10 grid h-9 w-9 place-items-center rounded-full border border-line bg-ink/70 text-bone-dim backdrop-blur transition-colors hover:border-gold/50 hover:text-gold"
                  >
